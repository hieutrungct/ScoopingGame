...
namespace Rubik.Account
{
    ...
    {
        public const string API_Account_Login = "/api/multiplayer/account/login";
        public const string API_Account_Register = "/api/multiplayer/account/register";
        public const string API_Account_LoginByDeviceID = "/api/multiplayer/account/login_by_device_id";
        public const string API_Account_LoginByToken = "/api/multiplayer/account/login_by_token";
        public const string API_Account_Delete_Account = "/api/multiplayer/account/delete_account";
        public const string API_Account_Link_Account = "/api/multiplayer/account/link_account";
        public const string API_Account_Confirm_Delete_Account = "/api/multiplayer/account/confirm_delete_account";
        public const string API_Account_LoginByGooglePlay = "/api/multiplayer/account/login_by_google_play";
        public const string API_Account_LinkGooglePlay = "/api/multiplayer/account/link_google_play";
        public const string API_Account_UnLinkGooglePlay = "/api/multiplayer/account/un_link_google_play";
        public const string API_Account_LoginByApple = "/api/multiplayer/account/login_by_apple";
        public const string API_Account_LinkApple = "/api/multiplayer/account/link_apple";

         public const string KeyToken = "Rubik_Multiplayer:KeyToken";
        public const string IsAutoLogin = "Rubik_Multiplayer:IsAutoLogin";
