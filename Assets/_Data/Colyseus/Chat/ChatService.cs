...
namespace Rubik.Chat
{
    ...
    public class ChatService : NTBehaviour
    {
        ...
        public List<string> ChatChannelRegisters = new List<string>();
        ...
        {
            base.Start();
            this.ChatChannelRegisters.Add(GetServerChatChannel());
            // Load Notify Chat
        ...
        {
            MsgDeliveryRoom.Instance.RegisterChannel(GetServerChatChannel());
            yield return new WaitForSeconds(1f);
            this.GetChatHistory(GetServerChatChannel());
        }
        ...
        public void UnRegisterChannelRoom(string channelKey)
        {
            ...
            if (this.ChatChannelRegisters.Contains(channelKey))
            {
                this.ChatChannelRegisters.Remove(channelKey);
            }
        }
        ...
        public void SendChat(string channelKey, string text, bool isSaveChat = true)
        {
            ...
            PlayerChatData playerChatData = new PlayerChatData(
                ...
                "",
                UserDataManager.Instance.GetPlayerLevel().level
            );
